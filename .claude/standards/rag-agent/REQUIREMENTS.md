# rag-agent — requirements index

| ID | slug | WHEN (summary) | SEV | REF |
|---|---|---|---|---|
| RAG-01 | foundry-responses-agent-pattern | constructing or registering an AIAgent | 🔴 | INVARIANTS#9 · ADR-0014 · ADR-0018 |
| RAG-02 | storage-aisearch-basic-plus-cosmos | selecting a vector or structured-data store | 🔴 | INVARIANTS#7 · ADR-0021 |
