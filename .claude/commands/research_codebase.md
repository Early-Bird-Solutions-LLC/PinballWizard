...
1. **Read any directly mentioned files first:**
   - If the user mentions specific files (specs, docs, JSON), read them FULLY first
...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **For codebase research:**
   - Use the **Explore (built-in)** agent to find WHERE files and components live
   - Use the **codebase-analyzer** agent to understand HOW specific code works (without critiquing it)
   - Use the **Explore (built-in)** agent to find examples of existing patterns (without evaluating them)
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `.superpowers/research/YYYY-MM-DD-description.md`
     - Format: `YYYY-MM-DD-description.md` where:
       - YYYY-MM-DD is today's date
       - description is a brief kebab-case description of the research topic
     - Examples:
       - `2026-06-19-cosmos-repository-pattern.md`
       - `2026-06-19-politeness-gate-flow.md`
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Branch**: [Current branch name]
     ...
     ## Code References
     - `path/to/file.cs:123` - Description of what's there
     - `another/file.cs:45-67` - Description of the code block
