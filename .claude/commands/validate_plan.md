...
✗ Linting issues: `dotnet build -warnaserror` (3 warnings)

### Code Review Findings

#### Matches Plan:
- Repository correctly implements [method]
...
#### Potential Issues:
- Missing index on Cosmos container could impact query cost
...
### Recommendations:
- Address build warnings before merge
...
3. `/describe_pr` - Generate PR description
4. `/ship` or `/pr-only` - Create PR
