...
public sealed class IntegrationTests : IDisposable
{
    ...
    public void Host_AllSourceScrapersAreRegistered()
    {
        ...
        // Seven sources: Manuals, Game Pages, Service Bulletins, JJP, JJP Support Docs,
        // AP Game Pages, AP Bulletins. If anyone removes a registration, this catches it.
        Assert.Equal(7, scrapers.Count);
        ...
        Assert.Contains(scrapers, s => s is JjpSupportDocScraper);
