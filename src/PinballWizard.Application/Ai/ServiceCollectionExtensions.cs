...
public static class ServiceCollectionExtensions
{
    ...
    // router. The IFoundryAgentFactory implementation lives in
    // Infrastructure (since it depends on Microsoft.Agents.AI.Foundry +
    // Azure.AI.Projects); the Infrastructure DI extension calls
    // AddAiRouter as part of AddAzureFoundryIntegration to ensure the
    // router and its factory ship together.
