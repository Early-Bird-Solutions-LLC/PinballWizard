...
/// SHA-256 hashing, and streaming to disk. Transient-failure retry, jitter, backoff, and
/// concurrency limiting are owned by the resilience pipeline registered on this type's
/// HttpClient in Program.cs (Microsoft.Extensions.Http.Resilience). This class is the
/// domain layer; the pipeline is the transport layer.
/// </summary>
