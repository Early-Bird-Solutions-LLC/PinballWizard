...
public sealed class GamePageScraper : ISourceScraper
{
        ...
        [System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        foreach (var game in games)
        {
            ...
            // Collect items in a list first — C# does not allow yield inside try-catch
            ...
            // Yield collected items outside try-catch
    ...
    // Internal DTOs for JavaScript interop — Playwright requires parameterless constructors
