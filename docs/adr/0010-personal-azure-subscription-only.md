...
- **Subscription ID:** `b1f33f17-74a9-4ecc-b46c-c4f31776b840` (pinwiz.ai — dedicated PinballWizard subscription, migrated from UpworkDemo on 2026-05-16)
...
- `feedback_personal_identity_only.md` (private project memory, not in this repo) — locked feedback memory; the rationale for treating personal/work identity separation as durable.
