...
| [0052](0052-deterministic-zero-content-shortcircuit.md) | Deterministic zero-content short-circuit in the Wizard ask pipeline (index-chunk-count gate) | Proposed |
