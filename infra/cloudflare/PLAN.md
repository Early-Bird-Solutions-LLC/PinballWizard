...
**Choice: Azure Blob Storage**, in the existing Earlybird Solutions subscription, using a dedicated container `tfstate-pinball-wizard`, with state encryption enabled.
